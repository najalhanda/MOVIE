...
<body>
		...
		<div
			...
			<nav id="navbar" class="navbar">
				<ul>
					...
					<li class="dropdown"><a href="mType"><span>장르 카테고리</span> <i
							class="bi bi-chevron-down dropdown-indicator"></i></a>
						<ul>
							<li><a href="typeForm" >로맨스</a></li>
							<li><a href="typeForm" >코믹</a></li>
							<li><a href="typeForm" >공포</a></li>
							<li><a href="typeForm" >액션</a></li>
							<li><a href="typeForm" >판타지</a></li>
							<li><a href="typeForm" >드라마</a></li>
							<li><a href="typeForm" >다큐멘터리</a></li>
							<li><a href="typeForm" >애니메이션</a></li>
	...
	<form action="movietype" method="POST" enctype="multipart/form-data">
	 ...
	 -->
				...
				<tr>
					...
					<td><textarea rows="20" cols="40" name="mStory"
							placeholder="100글자 이내"></textarea></td>
				</tr>
