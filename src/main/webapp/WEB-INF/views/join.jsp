...
<form action="euJoin" method="POST" encType="multipart/form-data">
		<table>
			...
			<tr>
				<th>아이디</th>
				<th><input type="text" name="euId" id="euId" size=33 class="input"/> <br />
				<span id="check1"></span><br /></th>

			</tr>
			<!-- 4 -->
			<tr id="tr1">
				<th>비밀번호</th>
				<th><input type="password" name="euPw" id="euPw"
					placeholder="영문, 숫자, 특수문자를 혼합해서 8자 이상" size=33 /> <br /> 
				<span id="check2"></span><br /></th>
			</tr>
			<tr id="tr1">
				<th>비밀번호 확인</th>
				<th><input type="password" id="checkPw" size=33 /> <br /> 
				<span id="check3"></span><br /></th>
			</tr>
			<!-- 5 -->
			<tr>
				<th>이름</th>
				<th><input type="text" name="euName" size=33 /> <br /> <br /></th>
			</tr>
			<!-- 6 -->
			<tr>
				<th>생년월일</th>
				<th><input type="date" name="euBirth" size=33 /> <br /></th>
			</tr>

			<!-- 7 -->
			<tr id="tr1">
				<th>성별 </th>
				<th>남자 <input type="radio" name="euGender" value="남자" /> 여자 <input
					type="radio" name="mGender" value="여자" /> <br /> <br />
				</th>
			</tr>
			<!-- 8 -->
			<tr id="tr1">
				<th>이메일</th>
				<th><input type="email" name="euEmail" size=33 /> <br /> <br /></th>
			</tr>
			<!-- 9 -->
			<tr>
				<th>연락처</th>
				<th><input type="text" name="euPhone" size=33 /> <br /> <br /></th>
			</tr>
			<tr>
				<th>주소</th>
				<th> 
			...
			<tr>
				<th>프로필 사진</th>
				<th><input type="file" name="euProfile"/> <br /> <br /></th>
			</tr>
			<!-- 10 -->
			<tr>
				<th colspan="2"><input type="submit" value="가입" class="bu" /> <input
					type="reset" value="다시작성" class="bu" /> <br /></th>
			</tr>
